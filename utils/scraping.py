...
# {'Name': <student name>, 'Address': <address>, 'Email':
# <email>, 'Phone': <phone>}
#
...
# For each alphabetical character, this visits each webpage and gets
# a table which contains student information
def get_data(browser):
    ...
    for pageNumber in range(0, num_pages+1):
        ...
        # The first table row (0th element of array) is always
...
if __name__ == '__main__':
    ...
    # This gets the links to each intiial web page (i.e page 0) that
    #  contains a query for an alphabetical character
    web_pages = []
    for page in pages:
